...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      <div className="relative bg-white w-full max-w-md rounded-xl shadow-sm border border-outline-variant/30 p-8 md:p-10 text-center space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button type="submit" variant="primary" fullWidth size="lg" className="mt-8 bg-primary hover:bg-surface-tint text-on-primary py-3 rounded-xl font-label-md font-semibold transition-all">
            Sign In
          </Button>
        </form>
